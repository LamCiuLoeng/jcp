...
<form id="artwork-file" method="post" enctype="multipart/form-data" action="/iteminfo/upload/" target = "upload_iframe">
<div style="float: left; padding-left: 900px;">
<div>
	<div class="item-artwork">
		<div style="float: left; padding-top: 3px;">
  			<strong class="fonts-c-369">&nbsp;&nbsp;Item Artwork File</strong>
  		</div>
