...
<form id="orderForm" action="/order/saveCLUpdate" method="post">
      ...
      <tr>
        <td><img src="/images/search_07.jpg" width="7" height="7" />&nbsp;&nbsp;<strong>MFG RN#:</strong>
          <input gtbfieldid="90" name="rnCode" id="rnCode" value="${orderHeader.rnCode}" class="input-style1" type="text" />&nbsp;
            ...
            <input name="wplCode" type="text" value="${orderHeader.wplCode}" class="input-style1" id="wplCode" gtbfieldid="91" />
...
<table class="gridTable" border="0" cellpadding="0" cellspacing="0" width="1200">
  <thead>
    <tr>
      ...
      <td align="center" width="105" class="wt-td">Special Price</td>
  ...
  <tbody>
    ...
    %endif
      ...
      <td align="center" class="t-td"><a id="FC_${item.id}" class="FC_item" href="#" onclick="showFCDiv(this, ${item.id})">Edit</a></td>
      <td align="center" class="t-td"><a id="WI_${item.id}" class="WI_item" href="#" onclick="showWIDiv(this, ${item.id})">Edit</a></td>
      <td align="center" class="t-td">${item.color|b}</td>
      <td align="center" class="t-td">${item.size|b}</td>
      <td align="center" class="t-td">${item.cat|b}</td>
