...
<div id="function-menu">
  ...
  <tbody><tr>
  	...
  	% endif
  	% if (in_group("Admin") or in_group("AE")) and poheader.status == 'CONFIRM':
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="50%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="26" align="right" class="title2">MFG RN#&nbsp;:</td>
                <td>&nbsp;</td>
                <td class="padding6px">&nbsp;${orderHeder.rnCode|b}</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td height="26" align="right" class="title2">JCP WPL# :</td>
                <td>&nbsp;</td>
                <td class="padding6px">&nbsp;${orderHeder.wplCode|b}</td>
                <td>&nbsp;</td>
                </tr>
              <tr>
               ...
               <tr>
                ...
                <td>&nbsp;</td>
                <td class="padding6px" valign="top">
                	% if image_url:
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td class="padding6px">&nbsp;${poheader.total_qty()|b}</td>
              </tr>
              <tr>
  ...
  <table cellspacing="0" cellpadding="0" border="0" width="1500" class="gridTable">
    <thead>
      <tr>
        ...
        <td align="center" width="80" class="wt-td">Brand Type</td>
        % endif
        <td align="center" width="105" class="wt-td">Fiber content</td>
        <td align="center" width="105" class="wt-td">Washing Instructions</td>
    ...
    %endif
      ...
      % if item.fcdetails:
      <a id="fibercontent" class="thickbox" href="/order/ajaxFiberContent?id=${item.id}">Fiber Content</a>
      % endif
      &nbsp;
      </td>
      <td align="center" class="t-td">
      % if item.washingInstruction:
      <a id="fibercontent" class="thickbox" href="/order/ajaxWashingInstruction?id=${item.id}">Washing Instruction<a>
      % endif
      &nbsp;
      </td>
  ...
  <table cellspacing="0" cellpadding="0" border="0" width="500">
    <tbody>
      ...
      <tr>
        ...
        <td width="201" class="STYLE1">Address</td>
