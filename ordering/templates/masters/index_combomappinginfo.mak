...
%if result:
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:900px">
		<thead>
			...
			<tr>
				<th width="150">Main Packaging Code</th>
				<th width="150">HangTag Packaging Code</th>
				<th width="150">Label Packaging Code</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<td>
					%if in_group("Admin"):
					<a href="/${funcURL}/update?id=${u.id}">${u.main_pkg_code}</a>
					%else:
					${u.main_pkg_code}
					%endif
					&nbsp;
				</td>
				<td>${u.hangtang_pkg_code}&nbsp;</td>
				<td>${u.label_pkg_code}&nbsp;</td>
			</tr>
			%endfor
			<tr><td style="text-align:right;border-right:0px;border-bottom:0px"  colspan="10"><span>${tmpl_context.paginators.result.pager()}, ${tmpl_context.paginators.result.item_count} records</span></td></tr>
		</tbody>
