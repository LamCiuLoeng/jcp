...
from ordering.model.jcpenny import JCPItemInfo
...
class BasicMasterController(BaseController):
    ...
    @expose('ordering.templates.masters.index')
    ...
    @expose('ordering.templates.masters.form')
    @tabFocus(tab_type="master")
    def add(self, **kw):
        return {
...
#       obj.set(**params)
    ...
    def searchMaster(self, kw):
        search_config={"name":["name", str],
                         ...
                         "combo_packaging_code": ["combo_packaging_code", str],
                         "combo_item": ["combo_item", bool],
                         ...
                         "path": ["path", str],
                         "status": ["status", int],
                         "multi_special_value": ["multi_special_value", int],
                         "item_type": ["item_type", int],
                         "active": ["active", int],
                         "sub": ["sub", str],
                         "rfid": ["rfid", str],
                         "stock": ["stock", str],
                         "main_pkg_code": ["main_pkg_code", str],
                         "hangtang_pkg_code": ["hangtang_pkg_code", str],
                         "label_pkg_code": ["label_pkg_code", str],
                         "combo_mapping": ["combo_mapping", bool],
                         }
